...
<\body>
  ...
  <\equation*>
    ...
    <around*|{|<big|prod><rsub|j>N<around*|(|\<theta\><rsub|j>,w<rsub|i
    j>,b<rsub|i j>|)>|}>,
  </equation*>
  ...
  To the numerical consideration, instead of fitting
  ...
  we have to employ some approximating approach. Let

  <\eqnarray*>
    <tformat|<table|<row|<cell|\<beta\><rsub|i>>|<cell|\<assign\>>|<cell|ln<around*|(|a<rsub|i><rsup|2>
    <around*|{|<big|prod><rsub|j>N<around*|(|\<theta\><rsub|j>,w<rsub|i
    j>,b<rsub|i j>|)>|}>|)>>>|<row|<cell|>|<cell|=>|<cell|ln
    a<rsub|i><rsup|2>+<big|sum><rsub|j><around*|{|-<frac|1|2><around*|(|w<rsub|i
    j><rsup|2> \<theta\><rsub|j>+b<rsub|i
    j>|)><rsup|2>+<frac|1|2>ln<around*|(|<frac|w<rsub|i j><rsup|2>|2
    \<pi\>>|)>|}>,>>>>
  </eqnarray*>
